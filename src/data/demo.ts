...
export const companies: Company[] = [
  { id: 'co_renault', establishmentId: E1, name: 'Garage Renault Vaise', address: '12 rue de la Mécanique', city: 'Lyon', zipCode: '69009', phone: '04 78 12 34 56', email: 'contact@renault-vaise.fr', sector: 'Automobile', studentsHosted: 14, reliability: 'high' },
  { id: 'co_peugeot', establishmentId: E1, name: 'Peugeot Lyon Sud', address: '5 avenue Berthelot', city: 'Lyon', zipCode: '69007', sector: 'Automobile', studentsHosted: 8, reliability: 'high' },
  { id: 'co_norauto', establishmentId: E1, name: 'Norauto Confluence', address: 'Centre Confluence', city: 'Lyon', zipCode: '69002', sector: 'Automobile', studentsHosted: 5, reliability: 'medium' },
  { id: 'co_carrefour', establishmentId: E1, name: 'Carrefour Part-Dieu', address: 'Centre commercial Part-Dieu', city: 'Lyon', zipCode: '69003', sector: 'Grande distribution', studentsHosted: 11, reliability: 'high' },
  { id: 'co_fnac', establishmentId: E1, name: 'Fnac Bellecour', address: '85 rue de la République', city: 'Lyon', zipCode: '69002', sector: 'Commerce', studentsHosted: 4, reliability: 'medium' },
  { id: 'co_atelier', establishmentId: E1, name: "Atelier d'ébénisterie Marquet", address: '14 rue des Artisans', city: 'Villeurbanne', zipCode: '69100', sector: 'Artisanat', studentsHosted: 3, reliability: 'high' },
  { id: 'co_axa', establishmentId: E1, name: 'AXA Assurances Lyon Centre', address: '21 cours Lafayette', city: 'Lyon', zipCode: '69006', sector: 'Services', studentsHosted: 6, reliability: 'high' },
  { id: 'co_mairie', establishmentId: E1, name: 'Mairie du 8e', address: '12 av. Jean Mermoz', city: 'Lyon', zipCode: '69008', sector: 'Public', studentsHosted: 2, reliability: 'low', internalNotes: 'Tuteur peu disponible, à surveiller.' },
]

export const tutors: Tutor[] = [
  { id: 'tu_1', establishmentId: E1, firstName: 'Pierre', lastName: 'Moreau', function: 'Chef d\'atelier', email: 'p.moreau@renault-vaise.fr', phone: '06 11 22 33 44', companyId: 'co_renault' },
  { id: 'tu_2', establishmentId: E1, firstName: 'Karim', lastName: 'Benali', function: 'Responsable mécanique', email: 'k.benali@peugeot-lyon.fr', companyId: 'co_peugeot' },
  { id: 'tu_3', establishmentId: E1, firstName: 'Sandra', lastName: 'Dubois', function: 'Manager rayon', email: 's.dubois@carrefour.fr', companyId: 'co_carrefour' },
  { id: 'tu_4', establishmentId: E1, firstName: 'Hugo', lastName: 'Robert', function: 'Responsable boutique', email: 'h.robert@fnac.com', companyId: 'co_fnac' },
  { id: 'tu_5', establishmentId: E1, firstName: 'Anne', lastName: 'Marquet', function: 'Maître artisan', email: 'a.marquet@atelier.fr', companyId: 'co_atelier' },
  { id: 'tu_6', establishmentId: E1, firstName: 'Nicolas', lastName: 'Faure', function: 'Conseiller commercial', email: 'n.faure@axa.fr', companyId: 'co_axa' },
  { id: 'tu_7', establishmentId: E1, firstName: 'Valérie', lastName: 'Petit', function: 'Chef d\'équipe', email: 'v.petit@norauto.fr', companyId: 'co_norauto' },
  { id: 'tu_8', establishmentId: E1, firstName: 'Olivier', lastName: 'Roux', function: 'Adjoint administratif', companyId: 'co_mairie' },
]
